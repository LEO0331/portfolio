...
function formatTimeline(startDate?: string, endDate?: string): string | undefined {
        ...
        <div className="flex h-full flex-col">
          <div className="border-b border-slate-200 px-4 py-3 sm:px-6 sm:py-4">
            <div className="flex items-start justify-between gap-3">
              ...
              <Button variant="ghost" size="sm" onClick={onClose} aria-label="Close project details">
                Close
              </Button>
            </div>
          </div>
          ...
          <div className="min-h-0 flex-1 overflow-y-auto px-4 py-4 sm:px-6 sm:py-5">
            ...
            <div className="mt-4 space-y-4 sm:mt-5">
              <div className="flex flex-wrap items-center gap-2">
                ...
                <Tag label={project.teamType === "solo" ? "Solo" : "Team"} />
              </div>
              ...
              <ListSection title="Features" items={project.features} itemKeyPrefix={`${project.id}-feature`} />
              <ListSection title="Challenges" items={project.challenges} itemKeyPrefix={`${project.id}-challenge`} />
              <ListSection title="Outcomes" items={project.outcomes} itemKeyPrefix={`${project.id}-outcome`} />
