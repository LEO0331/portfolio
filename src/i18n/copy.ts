...
const localizedCopy = {
  ...
  zh: {
    ...
    home: {
      ...
      proofPointsValue: "每個專案附上 Demo 與原始碼連結。",
      viewProjects: "查看專案",
      contact: "聯絡我",
      summaryEyebrow: "專業摘要",
      selectedWorkEyebrow: "精選作品",
      featuredProjects: "重點專案",
      featuredDescription: "依照精選與上線狀態排序，方便快速評估最具代表性的成果。",
      ...
      ctaDescription: "可先查看專案細節與實作品質，再進一步聯絡安排面談或合作。",
      browseProjects: "瀏覽專案",
      contactMe: "立即聯絡"
    },
    projects: {
      eyebrow: "作品一覽",
      title: "專案",
      intro: "可依分類、技術與狀態篩選。每個專案皆提供角色說明、技術棧、Demo 與原始碼連結。",
      search: "搜尋",
      searchHint: "快速找到目標專案",
      searchPlaceholder: "可搜尋名稱、標語、描述、分類或技術",
      filters: "篩選",
      category: "分類",
      technology: "技術",
      status: "狀態",
      ...
      noMatchDescription: "可清除篩選或改用其他關鍵字。",
      resetFilters: "重設篩選",
      role: "角色：",
      featurePreview: "功能摘要",
      liveDemo: "線上 Demo",
    ...
    about: {
      ...
      title: "關於我",
      p1:
        "我是全端工程師，專注於務實開發、清晰介面與可維護架構。從需求到部署，重視使用者體驗與工程品質並行。",
      p2:
        "我的工作方式結合前端交付與後端思維，讓功能在資料流程、模組邊界與長期維護上都具備一致性。",
      focusTitle: "工程重點",
      focusDescription: "涵蓋需求理解、UI 實作、功能邏輯與部署準備的端到端產品交付。",
      strengths: "優勢",
      domains: "關注領域",
      contactMe: "聯絡我",
    ...
    seo: {
      homeTitle: "全端工程師作品集",
      homeDescription: "Leo Chen 全端工程師作品集，展示精選專案、工程優勢，以及 Demo 與原始碼連結。",
      projectsTitle: "專案作品 | 全端作品集",
      projectsDescription: "可篩選的全端專案列表，含角色、技術棧、線上 Demo 與 GitHub 原始碼。",
